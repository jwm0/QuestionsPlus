...
export default class ProfileModal extends React.Component {
  ...
  render: function () {
    return(
      <div>
        <div id="profile-modal" className="reveal large" data-reveal="">
          ...
          <div id="modal-footer">
            <div id="modal-footer-text">
              ...
              <p><span className="modal-blue" style={{'font-weight':'normal;font-style:italic'}}>Vegan diet to stop diabetes progress</span></p>
